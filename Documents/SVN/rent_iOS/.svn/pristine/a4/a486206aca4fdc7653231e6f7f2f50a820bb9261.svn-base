...
// 传递当前界面
NSString * const CGRentBarPostCurrentPageNotification = @"CGRentBarPostCurrentPageNotification";
// 首页筛选传递参数
NSString * const CGHomePagePostParmentNotification = @"CGHomePagePostParment";
