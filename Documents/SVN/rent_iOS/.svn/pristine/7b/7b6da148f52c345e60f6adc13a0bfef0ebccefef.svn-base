...
- (void)setupConstraints
{
    ...
    if (_customView) {
        ...
        CGFloat padd = roundf(width/16.0);
        ...
        NSDictionary *metrics = @{@"padd": @(padd)};
        ...
        if ([self canShowTitle]) {
            ...
            [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-(padd@750)-[titleLabel(>=0)]-(padd@750)-|"
        ...
        if ([self canShowDetail]) {
            ...
            [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-(padd@750)-[detailLabel(>=0)]-(padd@750)-|"
                                                                                     options:0 metrics:metrics views:views]];
        }
        // or removes from its superview
        else {
        ...
        if ([self canShowButton]) {
            ...
            [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-(padd@750)-[button(>=0)]-(padd@750)-|"
                                                                                     options:0 metrics:metrics views:views]];
        }
        // or removes from its superview
        else {
