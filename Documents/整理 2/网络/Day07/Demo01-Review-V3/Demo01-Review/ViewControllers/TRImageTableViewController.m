...
//    TRDetailViewController *detailViewController = [[TRDetailViewController alloc] init];
    ...
    //创建TRDetailViewController对象(给定两个初始值)
    TRDetailViewController *detailViewController = [[TRDetailViewController alloc] initWithImageURL:imageURL withImageName:self.imageArray[indexPath.row]];
