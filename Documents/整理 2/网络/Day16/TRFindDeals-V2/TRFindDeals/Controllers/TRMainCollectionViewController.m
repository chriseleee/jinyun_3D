...
- (void)setupRightItems {
    ...
    //image
    [button setImage:[UIImage imageNamed:@"icon_map"] forState:UIControlStateNormal];
    //高亮image
    [button setImage:[UIImage imageNamed:@"icon_map_highlighted"] forState:UIControlStateHighlighted];
    [button addTarget:self action:@selector(clickMapButton) forControlEvents:UIControlEventTouchUpInside];
